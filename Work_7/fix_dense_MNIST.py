...
class DenseNet(torch.nn.Module):
    def __init__(self):
        ...
        self.layers = torch.nn.Sequential(
            torch.nn.Conv2d(in_channels=1, out_channels=self.num_channels, kernel_size=7, stride=1, padding=1),
            ...
            torch.nn.Linear(in_features=self.num_channels, out_features=10),
